...
const ComparisonTable = forwardRef(function ComparisonTable(
  ...
  return (
    <div style={{ overflow: "auto", width: "100%", border: "1px solid #ccc", maxHeight: "100%", flex: 1 }}>
      ...
      {/* Legend */}
      <div style={{ marginTop: 10, color: "#222", fontSize: 13, padding: "0 4px 8px", display: "flex", flexWrap: "wrap", gap: 8 }}>
        <span style={{ background: "#eaffea", padding: "2px 8px", border: "1px solid #ddd" }}>Match</span>
        <span style={{ background: "#fff5cc", padding: "2px 8px", border: "1px solid #ddd" }}>Case/Punctuation</span>
        <span style={{ background: "#ffe2e2", padding: "2px 8px", border: "1px solid #ddd" }}>Major mismatch</span>
        <span style={{ background: DOUBLE_ENTRY_BG, padding: "2px 8px", border: `1px solid ${DOUBLE_ENTRY_BORDER}`, fontWeight: 600 }}>⚠️ Double Entry</span>
      </div>
    </div>
  );
});
