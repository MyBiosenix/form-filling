...
function AdminForm() {
  ...
  const handleAdmin = async() => {
    ...
    if(valid){
      try{
        if(adminToEdit){
          const res = await axios.post(`https://api.freelancing-projects.com/api/admin/${adminToEdit._id}/edit-admin`,{
          ...
          const res = await axios.post('https://api.freelancing-projects.com/api/admin/create-admin',{
            name,email,role:admin,password,
          },
          {
            headers:{
